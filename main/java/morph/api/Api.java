...
public final class Api {
    ...
    public static boolean hasMorph(String playerName, boolean isClient) {
        try {
            return (Boolean) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("hasMorph", String.class, boolean.class)
                    .invoke(null, playerName, isClient);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static float morphProgress(String playerName, boolean isClient) {
        try {
            return (Float) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("morphProgress", String.class, boolean.class)
                    .invoke(null, playerName, isClient);
        } catch (Exception e) {
            return 1.0F;
        }
    ...
    public static EntityLivingBase getPrevMorphEntity(String playerName, boolean isClient) {
        try {
            return (EntityLivingBase) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("getPrevMorphEntity", String.class, boolean.class)
                    .invoke(null, playerName, isClient);
        } catch (Exception e) {
            return null;
        }
    ...
    public static EntityLivingBase getMorphEntity(String playerName, boolean isClient) {
        try {
            return (EntityLivingBase) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("getMorphEntity", String.class, boolean.class)
                    .invoke(null, playerName, isClient);
        } catch (Exception e) {
            return null;
        }
    ...
    public static void blacklistEntity(Class<? extends EntityLivingBase> clz) {
        try {
            Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("blacklistEntity", Class.class).invoke(null, clz);
        } catch (Exception e) {
        }
    }
    ...
    public static boolean forceMorph(EntityPlayerMP player, EntityLivingBase living) {
        try {
            return (Boolean) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("forceMorph", EntityPlayerMP.class, EntityLivingBase.class)
                    .invoke(null, player, living);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static void forceDemorph(EntityPlayerMP player) {
        try {
            Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("forceDemorph", EntityPlayerMP.class).invoke(null, player);
        } catch (Exception e) {
        }
    }
    ...
    public static String isEntityAMorph(EntityLivingBase living, boolean isClient) {
        try {
            return (String) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("isEntityAMorph", EntityLivingBase.class, boolean.class)
                    .invoke(null, living, isClient);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static void allowNextPlayerRender() {
        try {
            Class.forName("morph.common.core.ApiHandler").getDeclaredMethod("allowNextPlayerRender")
                    .invoke(null);
        } catch (Exception e) {
        }
    }
    ...
    public static ResourceLocation getMorphSkinTexture() {
        try {
            return (ResourceLocation) Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("getMorphSkinTexture").invoke(null);
        } catch (Exception e) {
    ...
    public static void registerArmForModel(ModelBase model, ModelRenderer arm) {
        try {
            Class.forName("morph.common.core.ApiHandler")
                    .getDeclaredMethod("registerArmForModel", ModelBase.class, ModelRenderer.class)
                    .invoke(null, model, arm);
        } catch (Exception e) {
        }
    }
}