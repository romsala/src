...
public abstract class Ability {
    ...
    public static void registerAbility(String name, Class<? extends Ability> clz) {
        try {
            Class.forName("morph.common.ability.AbilityHandler")
                    .getDeclaredMethod("registerAbility", String.class, Class.class)
                    .invoke(null, name, clz);
        } catch (Exception e) {
        }
    }
     ...
     * @param abilities
     */
    public static void mapAbilities(Class<? extends EntityLivingBase> entClass,
                                    Ability... abilities) {
        try {
            Class.forName("morph.common.ability.AbilityHandler")
                    .getDeclaredMethod("mapAbilities", Class.class, Ability[].class)
                    .invoke(null, entClass, abilities);
        } catch (Exception e) {
        }
    }
    ...
    public static void removeAbility(Class<? extends EntityLivingBase> entClass, String type) {
        try {
            Class.forName("morph.common.ability.AbilityHandler")
                    .getDeclaredMethod("removeAbility", Class.class, String.class)
                    .invoke(null, entClass, type);
        } catch (Exception e) {
        }
    }
    ...
    public static boolean hasAbility(Class<? extends EntityLivingBase> entClass, String type) {
        try {
            return (Boolean) Class.forName("morph.common.ability.AbilityHandler")
                    .getDeclaredMethod("hasAbility", Class.class, String.class)
                    .invoke(null, entClass, type);
        } catch (Exception e) {
            return false;
        }
    ...
    public static Ability createNewAbilityByType(String type, String[] arguments) {
        try {
            return (Ability) Class.forName("morph.common.ability.AbilityHandler")
                    .getDeclaredMethod("createNewAbilityByType", String.class, String[].class)
                    .invoke(null, type, arguments);
        } catch (Exception e) {
            return null;
        }
    }
